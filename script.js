            ...
            filteredProducts.forEach((product) => {
                ...
                const priceDisplay =
                    product.price !== product.originalPrice
                        ? `<p class="fs-6 text-danger"><span style="text-decoration: line-through; color: gray;">${formatRupiah(
                              product.originalPrice
                          )}</span> ${formatRupiah(product.price)}</p>`
                        ...
                        <div class="col-7 col-lg-8">
                            ...
                            <div class="size-options mt-2">
                                <label class="form-check-label">
                                    <input type="checkbox" name="size-${product.id}" value="Large" class="form-check-input">
                                    Large (+${formatRupiah(3000)})
                                </label>
                            </div>
                        </div>
